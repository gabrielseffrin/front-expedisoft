            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent
                            className="flex flex-col items-center justify-center py-12 text-muted-foreground border-2 border-dashed rounded-lg m-6 mt-0">
                            <Package className="h-10 w-10 mb-2 opacity-10"/>
                            <p className="text-sm">A listagem detalhada de produtos estará disponível em breve.</p>
                        </CardContent>
                    </Card>
